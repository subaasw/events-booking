...
let events: EventInfo[] = [
  {
    id: "event-1",
    name: "React 19 RC: New Features and Updates",
    tagline: "React 19 RC is now available on npm!",
    description:
      "In our React 19 RC Upgrade Guide, we shared step-by-step instructions for upgrading your app to React 19. In this event, we’ll give an overview of the new features in React 19, and how you can adopt them. \n\n- What’s new in React 19 \n- Improvements in React 19 \n- How to upgrade",
    image:
    ...
    times: [
      {
        id: "event-time-10",
        start: new Date("2024-06-29T09:00:00"),
        end: new Date("2024-06-29T10:30:00"),
        isBooked: false,
      },
    ],
  },
